...
public class Constants {
	...
	public static final int CELL_PIXELS = 80;
	public static final Dimension CELL_SIZE = new Dimension(CELL_PIXELS, CELL_PIXELS);
	
	public static final int GRID_SIZE = 9;
	public static final int BOX_SIZE = 3;
	
	public static final Font NUM_FONT = new Font(fontString, Font.PLAIN, 45);
	public static final Font NOTE_FONT = new Font(fontString, Font.PLAIN, 18);
	public static final Font SELECTED_NUM_FONT = new Font(fontString, Font.BOLD, 48);
	public static final Font SELECTED_NOTE_FONT = new Font(fontString, Font.BOLD, 20);
